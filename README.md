...
The HR Analytics Dashboard is an interactive Power BI project designed to analyze employee attrition and workforce performance through data visualization. It provides HR professionals with actionable insights into employee turnover, demographics, salary distribution, education background, and job roles. The dashboard enables organizations to identify attrition trends, understand key factors affecting employee retention, and support data-driven HR decision-making.
